...
//         if (item.firstName[item.firstName.length - 1] == "q") {
//             console.log(item.firstName);  
//             var a = true                     
//         }
//     }
//     if(!a){
//     throw new Error("Message de q ile biten ad yoxdur")
//     }
// }catch (error) {
//     console.error(error);
// }
...
// function topla() {
//     try{
//     let ID = prompt("Bir id daxil edin")
//     for(let item of users){
//         if (item.id == ID) {
//             console.log(item);  
//             var a = true 
...
//     }
//     if (!a) {
//         throw new Error(ID + " Daxil etdiyiniz id yoxdur və ya doğru deyil");
//     }
// }catch (error) {
//     console.error(error);
// }
...
//         }
//         if (!a) {
//             throw new Error(ID + "  bu id li isdifadecinin adress melumati movcud deyil");
//         }
//     }catch (error) {
//         console.error(error);
//     }
...
//             throw new Error("boy ve ya kilo melumati eksikdi ID:"+id)            
//         }
//     } catch (error) {
//         console.warn(error);
